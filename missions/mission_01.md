...
5. What information makes the message convincing?
    - BECAUSE OF IT'S FROM IT Support <support@school-security.example>
6. What could the attacker gain?
    - STUDENT CREDENTIALS
7. Identify at least five red flags.
    - THIS PHRASE "suspended today unless you verify your account immediately"
    - LINK
    - ENTERING THE STUDENT USERNAME
    - ENTERING THE STUDENT PASSWORD
    - the hyperlink should be https
